...
- (CNote*)convertToCNote
{
	...
	note->m_duration = m_duration;
	note->m_absoluteBeatStart = m_absoluteBeatStart;
	note->m_measureStart = m_measureStart;
	note->m_string = m_string;
	note->m_fret = m_fret;
	
	note->SetValue( [m_value cStringUsingEncoding:NSASCIIStringEncoding] );
