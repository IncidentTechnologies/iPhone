...
{
public:
    CoreMidiInterface(MidiCallback fnCallback, MidiConnectionChangeCallback fnConnectionChangeCallback, void *pContext);
    ~CoreMidiInterface();
...
public:
    ...
    NSLock * m_pSendLock;
    std::list<MIDISysexSendRequest*>*m_pSendQueue;
