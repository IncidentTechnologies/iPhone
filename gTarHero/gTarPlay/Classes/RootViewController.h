...
@interface RootViewController : UIViewController <UserProfileNavControllerDelegate, PopupViewControllerDelegate, GtarControllerObserver, FBSessionDelegate, GtarControllerDelegate, SongPlayerDelegate>
{
