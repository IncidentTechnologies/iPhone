...
//        iZTrashFX::TrashFXEngine::Create(&m_pTrashFXEngine, 1, g_GraphSampleRate );
//        iZCoreFX::CoreFXEngine::Create(&m_pCoreFXEngine, 1, g_GraphSampleRate );
//        
//        iZCoreFX::ReverbParameters parameters;
//        parameters.fDryMix= 60.0f;
//        parameters.fWetMix= 40.0f;
//        parameters.fRoomSize= 0.2f;
//        parameters.fDamping= 0.5f;
//        parameters.fWidth= 1.0f;
//        m_pCoreFXEngine->SetReverbParameters(parameters);
//        
//        iZCoreFX::DynamicsParameters dyP;
//        dyP.fMix = 100.0f;
//        m_pCoreFXEngine->SetDynamicsParameters(dyP);
//        m_pCoreFXEngine->SetDynamicsEnabled(true, "d3005777f0d49306891cde1f5107da8347f052693b285ef60f4a497f32c50f62", "Incident Technologies");
//        bool g;
//        m_pCoreFXEngine->IsDynamicsEnabled(g);
//        iZCoreFX::DynamicsParameters dyPOut;
//        m_pCoreFXEngine->GetDynamicsParameters(&dyPOut);
//        
//        iZCoreFX::DynamicsComponentParameters limiterParams;
//        limiterParams.fThreshold= -75.0f;
//        limiterParams.fRatio= 25.f;
//        limiterParams.fAttack= 5.f;
//        limiterParams.fRelease= 1000.f;
//        m_pCoreFXEngine->SetLimiterParameters( limiterParams );
//        m_pCoreFXEngine->SetCompressorParameters(limiterParams);
...
//{
//    m_pTrashFXEngine->SetTrashEnabled( bEnabled, "12d7fd069083ad1b94334ae0a09c0c143fab0ce9857cfb404414c51cf389c623", "Incident Technologies");
//}
//
//- (void) SetTrashDistortionAlgorithm:(unsigned int)uAlgorithm
//{
//    m_pTrashFXEngine->SetTrashDistortionAlgorithm( uAlgorithm );
//}
//
//- (void) SetIZotopeReverbEnabled:(bool)bEnabled
//{
//    m_pCoreFXEngine->SetReverbEnabled(bEnabled, "26c007723a1d17c7187fa60e5c86359d6384b692817f435e6d301cdf08e34d05", "Incident Technologies");
//}
//
//- (void) SetIZotopeReverbWet:(float)wet
//{
//    iZCoreFX::ReverbParameters oldParameters;
//    iZCoreFX::ReverbParameters parameters;
//    m_pCoreFXEngine->GetReverbParameters(&oldParameters);
//    parameters.fDryMix= 100 - wet;
//    parameters.fWetMix= wet;
//    parameters.fRoomSize= oldParameters.fRoomSize;
//    parameters.fDamping= oldParameters.fDamping;
//    parameters.fWidth= oldParameters.fWidth;
//    m_pCoreFXEngine->SetReverbParameters(parameters);
//}
//
...
//    iZCoreFX::ReverbParameters parameters;
//    m_pCoreFXEngine->GetReverbParameters(&oldParameters);
//    parameters.fDryMix= oldParameters.fDryMix;
//    parameters.fWetMix= oldParameters.fWetMix;
//    parameters.fRoomSize= roomSize;
//    parameters.fDamping= oldParameters.fDamping;
//    parameters.fWidth= oldParameters.fWidth;
//    m_pCoreFXEngine->SetReverbParameters(parameters);
//}
...
//    parameters.fRoomSize= oldParameters.fRoomSize;
//    parameters.fDamping= oldParameters.fDamping;
//    parameters.fWidth= width;
//    m_pCoreFXEngine->SetReverbParameters(parameters);
//}
//
//- (void) SetLimiterParams:(double)threshold thrshldDb:(double)db r:(double)ratio a:(double)attackMs rel:(double)releaseMs
//{
//    m_pCompressor->Setup(threshold, ratio, attackMs, releaseMs, g_GraphSampleRate);
//    
//    iZCoreFX::DynamicsComponentParameters limiterParams;
//    limiterParams.fThreshold= (float)db;
//    limiterParams.fRatio= (float)ratio;
//    limiterParams.fAttack= (float)attackMs;
//    limiterParams.fRelease= (float)releaseMs;
//    m_pCoreFXEngine->SetLimiterParameters( limiterParams );
//    m_pCoreFXEngine->SetCompressorParameters(limiterParams);
//}
//
...
//{
//    //m_pCoreFXEngine->SetLimiterEnabled( bEnabled, "2a783eeb19c43bc4b7a183ca6ca88301a3e777d67087b22eb1eb66d7864dea13", "Incident Technologies" );
//    m_pCoreFXEngine->SetCompressorEnabled( bEnabled, "0818877b6779ee2f4b800951789c1ec1893549ef679589b8cfbedcb4f9168a21", "Incident Technologies" );
//    
//    bool isEn;
//    //m_pCoreFXEngine->IsLimiterEnabled(isEn);
//    m_pCoreFXEngine->IsCompressorEnabled(isEn);
//    iZCoreFX::DynamicsComponentParameters limiterParams;
//    //m_pCoreFXEngine->GetLimiterParameters(&limiterParams);
//    m_pCoreFXEngine->GetCompressorParameters(&limiterParams);
//    NSLog(@"iZ limiter enabled: %d", isEn);
//     NSLog(@"iZ limiter Threshold:%f Ratio:%f, attack:%f release:%f", limiterParams.fThreshold,limiterParams.fRatio,limiterParams.fAttack,limiterParams.fRelease);
//}
...
//    iZTrashFX::TrashFXEngine::Destroy( m_pTrashFXEngine );
//    iZCoreFX::CoreFXEngine::Destroy( m_pCoreFXEngine );
//    m_pTrashFXEngine = nil;
//    m_pCoreFXEngine = nil;
