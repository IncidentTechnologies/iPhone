...
@interface RootViewController : UIViewController <UserProfileNavControllerDelegate, PopupViewControllerDelegate, GuitarControllerObserver, FBSessionDelegate, SongPlayerDelegate>
{
