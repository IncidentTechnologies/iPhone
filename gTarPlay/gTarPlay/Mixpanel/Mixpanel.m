...
+ (void)assertPropertyTypes:(NSDictionary *)properties
{
    for (id k in properties) {
        NSString *msgString = [NSString stringWithFormat:@"%@ property keys must be NSString. got: %@ %@", self, [k class], k];

        NSAssert([k isKindOfClass: [NSString class]], msgString);
        ...
        msgString = [NSString stringWithFormat:@"%@ property values must be NSString, NSNumber, NSNull, NSArray, NSDictionary, NSDate or NSURL. got: %@ %@", self, [[properties objectForKey:k] class], [properties objectForKey:k]];
...
- (void)increment:(NSDictionary *)properties
{
    ...
    for (id v in [properties allValues]) {
        NSString *msgString = [NSString stringWithFormat:@"%@ increment property values should be NSNumber. found: %@", self, v];
        NSAssert([v isKindOfClass:[NSNumber class]], msgString);
    }
