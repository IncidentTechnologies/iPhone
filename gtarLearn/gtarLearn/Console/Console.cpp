...
RESULT Console::ExecuteConsoleFunction(char *pszCommand)
{
    ...
    switch(static_cast<ConsoleFunction>(*it).arguments)
    {
        case 1:
        {
            CallbackRet = (int)((FP1)(static_cast<ConsoleFunction>(*it).Function))(this);
		...
		case 2:
		{
			if(!fUseDefaultArguments)
				CallbackRet = (int)((FP2)(static_cast<ConsoleFunction>(*it).Function))(this, Args[1]);
			else
				CallbackRet = (int)((FP2)(static_cast<ConsoleFunction>(*it).Function))(this, static_cast<ConsoleFunction>(*it).ppszDefaultArguments[0]);
		...
		{
			if(!fUseDefaultArguments)
				CallbackRet = (int)((FP3)(static_cast<ConsoleFunction>(*it).Function))(this, Args[1], Args[2]);
			else
				CallbackRet = (int)((FP3)(static_cast<ConsoleFunction>(*it).Function))(this, static_cast<ConsoleFunction>(*it).ppszDefaultArguments[0]
		...
		{
			if(!fUseDefaultArguments)
				CallbackRet = (int)((FP4)(static_cast<ConsoleFunction>(*it).Function))(this, Args[1], Args[2], Args[3]);
			else
				CallbackRet = (int)((FP4)(static_cast<ConsoleFunction>(*it).Function))(this, static_cast<ConsoleFunction>(*it).ppszDefaultArguments[0],
																						     static_cast<ConsoleFunction>(*it).ppszDefaultArguments[1],
		...
		{
			if(!fUseDefaultArguments)
				CallbackRet = (int)((FP5)(static_cast<ConsoleFunction>(*it).Function))(this, Args[1], Args[2], Args[3], Args[4]);
			else
				CallbackRet = (int)((FP5)(static_cast<ConsoleFunction>(*it).Function))(this, static_cast<ConsoleFunction>(*it).ppszDefaultArguments[0],
																						     static_cast<ConsoleFunction>(*it).ppszDefaultArguments[1],
																							 static_cast<ConsoleFunction>(*it).ppszDefaultArguments[2],
		...
		{
			if(!fUseDefaultArguments)
				CallbackRet = (int)((FP6)(static_cast<ConsoleFunction>(*it).Function))(this, Args[1], Args[2], Args[3], Args[4], Args[5]);
			else
				CallbackRet = (int)((FP6)(static_cast<ConsoleFunction>(*it).Function))(this, static_cast<ConsoleFunction>(*it).ppszDefaultArguments[0],
																						     static_cast<ConsoleFunction>(*it).ppszDefaultArguments[1],
																							 static_cast<ConsoleFunction>(*it).ppszDefaultArguments[2],
																							 static_cast<ConsoleFunction>(*it).ppszDefaultArguments[3],
		...
		{
			if(!fUseDefaultArguments)
				CallbackRet = (int)((FP7)(static_cast<ConsoleFunction>(*it).Function))(this, Args[1], Args[2], Args[3], Args[4], Args[5], Args[6]);
			else
				CallbackRet = (int)((FP7)(static_cast<ConsoleFunction>(*it).Function))(this, static_cast<ConsoleFunction>(*it).ppszDefaultArguments[0],
																						     static_cast<ConsoleFunction>(*it).ppszDefaultArguments[1],
																							 static_cast<ConsoleFunction>(*it).ppszDefaultArguments[2],
																							 static_cast<ConsoleFunction>(*it).ppszDefaultArguments[3],
																							 static_cast<ConsoleFunction>(*it).ppszDefaultArguments[4],
